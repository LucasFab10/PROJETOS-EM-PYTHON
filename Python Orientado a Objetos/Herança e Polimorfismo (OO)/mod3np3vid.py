...
class Voando:
    ...
    # Mixin para animais que podem voar
...
class Nadador:
    ...
    # Subclasse Pato que herda de Animal, voando e nadando

class Pato(Animal, Voando, Nadador):
...
print(fazer_movimento(pato)) # Saída: O pato Donald está andando, Pato Donald está nadando, Pato Donald está voando.
